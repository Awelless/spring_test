...
public class MessageListTest {
    ...
    public void mainPageTest() throws Exception {
        this.mockMvc
                ...
                .andExpect(xpath("//div[@id='navbarSupportedContent']/div[1]").string("catlover"));
    }
    ...
    public void filterMessageTest() throws Exception {
        this.mockMvc
                .perform(get("/messages?filter=msg"))
                .andDo(print())
                .andExpect(authenticated())
    ...
    @Test
    public void addMessageList() throws Exception {
        ...
        this.mockMvc
                ...
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=10]/div/i").string("#msg"));
    }
}
